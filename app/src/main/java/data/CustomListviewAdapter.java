...
import com.example.dee.caloriescounterandroidapp.FoodItemDetailsActivity;
import com.example.dee.caloriescounterandroidapp.R;
...
public class CustomListviewAdapter extends ArrayAdapter<Food> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        row.setOnClickListener( // when they click on a row go to next screen
